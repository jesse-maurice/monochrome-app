...
const PhotoDetailsModal = ({ image, onClose }: PhotoDetailsModalProps) => {
  if (!image) return null;
  
  return (
    <div className="fixed inset-0 font-jakarta z-50 bg-black bg-opacity-90 flex justify-center items-center overflow-hidden">
